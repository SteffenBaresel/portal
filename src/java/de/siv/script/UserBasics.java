...
"    $('#UserProfile').html('<div id=\"UserProfileDialog\" title=\"Profileinstellungen bearbeiten\">" +
"    <div id=\"UserProfileImg\"><img id=UserProfileConfig2 src=\"layout/images/DefaultProfile.png\" /></div><div onclick=\"UploadPicture();\" id=\"UserProfileImgHover\">Bild hochladen ...</div>" +
...
"                        if (json.UPDATED == \"1\") {\n" +
"                            DialogMailComplete(\"#UserProfileSuccess\",\"Mailadresse erfolgreich geupdated\",\"Die Mailadresse wurde erfolgreich geupdated.\");\n" +
"                        } else {\n" +
"                            DialogMailComplete(\"#UserProfileSuccess\",\"+++ Fehler beim updated der Mailadresse +++\",\"<font color=red>Die Mailadresse konnte NICHT geupdated werden.</font>\");\n" +
"                        }\n" +
"                    },\n" +
...
"                var active;\n" +
"                if (this.UACT == \"1\") { active = \"<img onclick=\\\"ActivateUser(\\'0\\',\\'\" + this.UUID + \"\\');\\\" src=\\\"layout/images/icons/accept.png\\\" title=\\\"Nutzer deaktivieren\\\"/>\"; } else { active = \"<img onclick=\\\"ActivateUser(\\'1\\',\\'\" + this.UUID + \"\\')\\\" src=\\\"layout/images/icons/cross-circle.png\\\" title=\\\"Nutzer aktivieren\\\"/>\"; }" +
"                $('#UserMgmntUserList table').append('<tr><td>' + $.base64.decode( this.USDC ) + '</td><td>' + this.UCRT + '</td><td>' + this.ULAL + '</td><td>' + active + '</td><td><img onclick=\"DeleteEntry(\\'USER\\',\\'' + this.UUID + '\\')\" src=\"layout/images/icons/minus-circle.png\" title=\"Nutzer l&ouml;schen\"/></td></tr>');\n" +
"            });\n" +
"            $('#UserMgmntGroupList table').html('<tr><th>Gruppenname:</th><th>Gruppenbeschreibung:</th><th></th></tr>');\n" +
"            $.each(json.GROUPS, function() {\n" +
"                $('#UserMgmntGroupList table').append('<tr><td>' + $.base64.decode( this.GRNM ) + '</td><td>' + $.base64.decode( this.GRDC ) + '</td><td><img onclick=\"DeleteEntry(\\'GROUP\\',\\'' + this.GRID + '\\')\" src=\"layout/images/icons/minus-circle.png\" title=\"Gruppe l&ouml;schen\"/></td></tr>');\n" +
"            });\n" +
"            $('#UserMgmntRoleList table').html('<tr><th>Rollenname:</th><th>Rollenbeschreibung:</th><th></th></tr>');\n" +
"            $.each(json.ROLES, function() {\n" +
"                $('#UserMgmntRoleList table').append('<tr><td>' + $.base64.decode( this.RLNM ) + '</td><td>' + $.base64.decode( this.RLDC ) + '</td><td><img onclick=\"DeleteEntry(\\'ROLE\\',\\'' + this.RLID + '\\')\" src=\"layout/images/icons/minus-circle.png\" title=\"Rolle l&ouml;schen\"/></td></tr>');\n" +
"            });\n" +
"            $('#UserMgmntPrivList table').html('<tr><th>Privilegname:</th><th>Privilegbeschreibung:</th><th></th></tr>');\n" +
"            $.each(json.PRIVS, function() {\n" +
"                $('#UserMgmntPrivList table').append('<tr><td>' + $.base64.decode( this.PRNM ) + '</td><td>' + $.base64.decode( this.PRDC ) + '</td><td><img onclick=\"DeleteEntry(\\'PRIV\\',\\'' + this.PRID + '\\')\" src=\"layout/images/icons/minus-circle.png\" title=\"Privileg l&ouml;schen\"/></td></tr>');\n" +
"            });\n" +
"        },\n" +
"        dataType: 'json',\n" +
"        cache: false\n" +
...
"                $('#ptr' + PRID).hover( function() { $( this ).css('background-color','#004279'); $('#rtr' + PRID).css('background-color','#004279'); }, function() { $( this ).css('background-color','#004c8a'); $('#rtr' + PRID).css('background-color','#004c8a'); } );\n" +
"                $('#rtr' + PRID).hover( function() { $( this ).css('background-color','#004279'); $('#ptr' + PRID).css('background-color','#004279'); }, function() { $( this ).css('background-color','#004c8a'); $('#ptr' + PRID).css('background-color','#004c8a'); } );\n" +
"                $.each(json.ROLE, function() {\n" +
"                    if(c == 0) {\n" +
"                        $('#UserMgmntRoPrList2 table tr#thd').append('<th>' + $.base64.decode( this.ROLE_DC ) + '</th>');\n" +
"                    }" +
"                    $('#UserMgmntRoPrList2 table tr#rtr' + PRID ).append('<td><img id=\"PrID' + PRID + '_RlID' + this.ROLE_ID + '\" onclick=\"UpdateRolePriv(\\'' + this.ROLE_ID + '\\',\\'' + PRID + '\\');\" src=\"layout/images/icons/cross-circle.png\" title=\"Privileg erteilen\"/></td>');\n" +
"                });\n" +
"                c++;" +
"            });\n" +
"            $.each(json.ROLE, function() {\n" +
...
"                    $('#PrID' + this.ROLE_PRIV[i] + '_RlID' + ROLEID).attr('src','layout/images/icons/accept.png');\n" +                    
...
"                $('#pgtr' + ROID).hover( function() { $( this ).css('background-color','#004279'); $('#rgtr' + ROID).css('background-color','#004279'); }, function() { $( this ).css('background-color','#004c8a'); $('#rgtr' + ROID).css('background-color','#004c8a'); } );\n" +
"                $('#rgtr' + ROID).hover( function() { $( this ).css('background-color','#004279'); $('#pgtr' + ROID).css('background-color','#004279'); }, function() { $( this ).css('background-color','#004c8a'); $('#pgtr' + ROID).css('background-color','#004c8a'); } );\n" +
"                $.each(json.GROUP, function() {\n" +
"                    if(c == 0) {\n" +
"                        $('#UserMgmntGrRoList2 table tr#tghd').append('<th>' + $.base64.decode( this.GROUP_DC ) + '</th>');\n" +
"                    }" +
"                    $('#UserMgmntGrRoList2 table tr#rgtr' + ROID ).append('<td><img id=\"RoID' + ROID + '_GrID' + this.GROUP_ID + '\" onclick=\"UpdateGroupRole(\\'' + this.GROUP_ID + '\\',\\'' + ROID + '\\');\" src=\"layout/images/icons/cross-circle.png\" title=\"Rolle zuweisen\"/></td>');\n" +
"                });\n" +
"                c++;" +
"            });\n" +
"            $.each(json.GROUP, function() {\n" +
...
"                    $('#RoID' + this.GROUP_ROLE[i] + '_GrID' + GROUPID).attr('src','layout/images/icons/accept.png');\n" +                    
...
"                $('#putr' + GRID).hover( function() { $( this ).css('background-color','#004279'); $('#rutr' + GRID).css('background-color','#004279'); }, function() { $( this ).css('background-color','#004c8a'); $('#rutr' + GRID).css('background-color','#004c8a'); } );\n" +
"                $('#rutr' + GRID).hover( function() { $( this ).css('background-color','#004279'); $('#putr' + GRID).css('background-color','#004279'); }, function() { $( this ).css('background-color','#004c8a'); $('#putr' + GRID).css('background-color','#004c8a'); } );\n" +
"                $.each(json.USER, function() {\n" +
"                    if(c == 0) {\n" +
"                        $('#UserMgmntUsGrList2 table tr#tuhd').append('<th>' + $.base64.decode( this.USER_DC ) + '</th>');\n" +
"                    }" +
"                    $('#UserMgmntUsGrList2 table tr#rutr' + GRID ).append('<td><img id=\"GrID' + GRID + '_UsID' + this.USER_ID + '\" onclick=\"UpdateUserGroup(\\'' + this.USER_ID + '\\',\\'' + GRID + '\\');\" src=\"layout/images/icons/cross-circle.png\" title=\"Gruppe zuweisen\"/></td>');\n" +
"                });\n" +
"                c++;" +
"            });\n" +
"            $.each(json.USER, function() {\n" +
...
"                    $('#GrID' + this.USER_GROUP[i] + '_UsID' + USERID).attr('src','layout/images/icons/accept.png');\n" +                    
...
"            crossDomain: true,\n" +
"            success: function() {\n" +
"                DialogSuccess('#Configuration','Der Eintrag wurde erfolgreich gesetzt.');\n" +
"                FillUserManagement();\n" +
"                FillUserManagementUsGr();\n" +
"                FillUserManagementRoPri();\n" +
"                FillUserManagementGrRo();\n" +
...
"        crossDomain: true,\n" +
"        success: function() {\n" +
"            DialogSuccess('#Configuration','Der Eintrag wurde erfolgreich entfernt.');\n" +
"            FillUserManagement();\n" +
"            FillUserManagementUsGr();\n" +
"            FillUserManagementRoPri();\n" +
"            FillUserManagementGrRo();\n" +
...
"        crossDomain: true,\n" +
"        success: function() {\n" +
"            DialogSuccess('#Configuration','Der User wurde erfolgreich angepasst.');\n" +
"            FillUserManagement();\n" +
"        },\n" +
"        dataType: 'json',\n" +
"        cache: false\n" +
...
"        crossDomain: true,\n" +
"        success: function() {\n" +
"            DialogSuccess('#Configuration','Die Rolle wurde erfolgreich angepasst.');\n" +
"            FillUserManagementRoPri();\n" +
"        },\n" +
"        dataType: 'json',\n" +
"        cache: false\n" +
...
"        crossDomain: true,\n" +
"        success: function() {\n" +
"            DialogSuccess('#Configuration','Die Gruppe wurde erfolgreich angepasst.');\n" +
"            FillUserManagementGrRo();\n" +
"        },\n" +
"        dataType: 'json',\n" +
"        cache: false\n" +
...
"        crossDomain: true,\n" +
"        success: function() {\n" +
"            DialogSuccess('#Configuration','Der Nutzer wurde erfolgreich angepasst.');\n" +
"            FillUserManagementUsGr();\n" +
"        },\n" +
"        dataType: 'json',\n" +
"        cache: false\n" +
