...
"}\n");
    ...
    if(Functions.UserIsPermitted(Uid,"managed_services")) {
        ...
        out.println("" +
                ...
                "    $('#SidebarSearchFilter').append('<div class=\"DivSearchFilter\" id=\"SFCustomer\" onclick=\"SearchCustomer();\"><img id=\"SearchImg\" src=\"layout/images/portal.png\"><span>Kunden</span></div>');\n" +
        ...
        out.println("" +
                ...
                "<table>" +
                "<tr><td>Kundenname:</td></tr><tr><td><input type=\"text\" value=\"Musterstadtwerk\" id=\"cname\" onclick=\"ClearValue(\\'cname\\');\"/></td></tr><tr><td>Kundennummer:</td></tr><tr><td><input type=\"text\" value=\"123456\" id=\"cnumber\" onclick=\"ClearValue(\\'cnumber\\');\"/></td></tr>" +
                "<tr><td>Kontakt E-Mail Adressen: (mail1,mai2,mailn)</td></tr><tr><td><input type=\"text\" value=\"admin@musterstadtwerk.de\" id=\"cmail\" onclick=\"ClearValue(\\'cmail\\');\"/></td></tr><tr><td>Eskalationsmailadressen: (mail1,mail2,mailn)</td></tr><tr><td><input type=\"text\" value=\"escalation-manager@musterstadtwerk.de\" id=\"cesmail\" onclick=\"ClearValue(\\'cesmail\\');\"/></td></tr>" +
                "<tr><td>Kontakt Adresse:</td></tr><tr><td><div contenteditable=\"true\" id=\"caddress\"></div></td></tr>" +
                "</table>" +
                "</div>" +
                "<div id=\"CreateCustomerMiddle\">" +
                "<table>" +
                "<tr><td>Weitere Informationen zu diesem Kunden:</td></tr><tr><td><div id=\"ccomm\"><div id=\"ccommc\"></div></div></td></tr>" +
                "</table>" +
                "</div>" +
                "<div id=\"CreateCustomerRight\">" +
                "<table>" +
                "<tr><td>Welche Pflegevertr&auml;ge sind dem Kunden zugeordnet?</td></tr>" +
                "<tr><td><div id=\"ContractTypeDiv1\"><select id=\"ContractType1\"><option selected value=\"0000\">Vertrag 1: Bitte Ausw&auml;hlen</option></select></div><input id=\"ContractType1AN\" type=text value=\"Auftragsnummer\" onclick=\"ClearValue(\\\'ContractType1AN\\\');\"/><input id=\"ContractType1PV\" type=text value=\"Produkt Version\" onclick=\"ClearValue(\\\'ContractType1PV\\\');\"/><input id=\"ContractType1PI\" type=text value=\"Produkt Information\" onclick=\"ClearValue(\\\'ContractType1PI\\\');\"/></td></tr>" +
                "<tr><td><div id=\"ContractTypeDiv2\"><select id=\"ContractType2\"><option selected value=\"0000\">Vertrag 2: Bitte Ausw&auml;hlen</option></select></div><input id=\"ContractType2AN\" type=text value=\"Auftragsnummer\" onclick=\"ClearValue(\\\'ContractType2AN\\\');\"/><input id=\"ContractType2PV\" type=text value=\"Produkt Version\" onclick=\"ClearValue(\\\'ContractType2PV\\\');\"/><input id=\"ContractType2PI\" type=text value=\"Produkt Information\" onclick=\"ClearValue(\\\'ContractType2PI\\\');\"/></td></tr>" +
                "<tr><td><div id=\"ContractTypeDiv3\"><select id=\"ContractType3\"><option selected value=\"0000\">Vertrag 3: Bitte Ausw&auml;hlen</option></select></div><input id=\"ContractType3AN\" type=text value=\"Auftragsnummer\" onclick=\"ClearValue(\\\'ContractType3AN\\\');\"/><input id=\"ContractType3PV\" type=text value=\"Produkt Version\" onclick=\"ClearValue(\\\'ContractType3PV\\\');\"/><input id=\"ContractType3PI\" type=text value=\"Produkt Information\" onclick=\"ClearValue(\\\'ContractType3PI\\\');\"/></td></tr>" +
                "<tr><td><div id=\"ContractTypeDiv4\"><select id=\"ContractType4\"><option selected value=\"0000\">Vertrag 4: Bitte Ausw&auml;hlen</option></select></div><input id=\"ContractType4AN\" type=text value=\"Auftragsnummer\" onclick=\"ClearValue(\\\'ContractType4AN\\\');\"/><input id=\"ContractType4PV\" type=text value=\"Produkt Version\" onclick=\"ClearValue(\\\'ContractType4PV\\\');\"/><input id=\"ContractType4PI\" type=text value=\"Produkt Information\" onclick=\"ClearValue(\\\'ContractType4PI\\\');\"/></td></tr>" +
                "<tr><td><div id=\"ContractTypeDiv5\"><select id=\"ContractType5\"><option selected value=\"0000\">Vertrag 5: Bitte Ausw&auml;hlen</option></select></div><input id=\"ContractType5AN\" type=text value=\"Auftragsnummer\" onclick=\"ClearValue(\\\'ContractType5AN\\\');\"/><input id=\"ContractType5PV\" type=text value=\"Produkt Version\" onclick=\"ClearValue(\\\'ContractType5PV\\\');\"/><input id=\"ContractType5PI\" type=text value=\"Produkt Information\" onclick=\"ClearValue(\\\'ContractType5PI\\\');\"/></td></tr>" +
                "<tr><td><div id=\"ContractTypeDiv6\"><select id=\"ContractType6\"><option selected value=\"0000\">Vertrag 6: Bitte Ausw&auml;hlen</option></select></div><input id=\"ContractType6AN\" type=text value=\"Auftragsnummer\" onclick=\"ClearValue(\\\'ContractType6AN\\\');\"/><input id=\"ContractType6PV\" type=text value=\"Produkt Version\" onclick=\"ClearValue(\\\'ContractType6PV\\\');\"/><input id=\"ContractType6PI\" type=text value=\"Produkt Information\" onclick=\"ClearValue(\\\'ContractType6PI\\\');\"/></td></tr>" +
                "</table>" +
                "</div>" +
                "</div>');\n" +
                "" +
        ...
        out.println("" +
                ...
                "                var img = '';\n" +
                "                if(json.CONTRACTS.length > 1) { img = '<img src=\"layout/images/icons/minus-circle.png\" title=\"Vertrag l&ouml;schen\" onclick=\"DeleteContract(\\\'' + $.base64.encode( $('#cnameEselect').val() ) + '\\\',\\\'' + this.CCID + '\\\');\"/>'; }\n" +
        ...
        out.println("" +
                ...
                "<div id=\"CreateCustomerLeft\">" +
                "<table>" +
                "<tr><td>Kundenname:</td></tr><tr><td><div id=\"cnameE\"><select id=\"cnameEselect\" onchange=\"GetSingleCustomer(\\\'cnameEselect\\\');\"><option selected value=\"0000\">Kunde w&auml;hlen</option></select></div></td></tr><tr><td>Kundennummer:</td></tr><tr><td><input type=\"text\" id=\"cnumberE\" /></td></tr>" +
                "<tr><td>Kontakt E-Mail Adressen: (mail1,mai2,mailn)</td></tr><tr><td><input type=\"text\" id=\"cmailE\" /></td></tr><tr><td>Eskalationsmailadressen: (mail1,mail2,mailn)</td></tr><tr><td><input type=\"text\" id=\"cesmailE\" /></td></tr>" +
                "<tr><td>Kontakt Adresse:</td></tr><tr><td><div contenteditable=\"true\" id=\"caddressE\"></div></td></tr>" +
                "</table>" +
                "</div>" +
                "<div id=\"CreateCustomerMiddle\">" +
                "<table>" +
                "<tr><td>Weitere Informationen zu diesem Kunden:</td></tr><tr><td><div id=\"ccommE\"><div id=\"ccommEc\"></div></div></td></tr>" +
                "</table>" +
                "</div>" +
                "<div id=\"CreateCustomerRight\">" +
                "<table>" +
                ...
                "</table>" +
                "<table>" +
                "<tr><td>Weiteren Pflegevertrag hinzuf&uuml;gen:</td></tr>" +
                "<tr><td><div id=\"ContractTypeDiv1\"><select id=\"ContractType1\"><option selected value=\"0000\">Vertrag 1: Bitte Ausw&auml;hlen</option></select></div><input id=\"ContractType1AN\" type=text value=\"Auftragsnummer\" onclick=\"ClearValue(\\\'ContractType1AN\\\');\"/><input id=\"ContractType1PV\" type=text value=\"Produkt Version\" onclick=\"ClearValue(\\\'ContractType1PV\\\');\"/><input id=\"ContractType1PI\" type=text value=\"Produkt Information\" onclick=\"ClearValue(\\\'ContractType1PI\\\');\"/></td></tr>" +
                "</table>" +
                "</div>" +
                "</div>');\n" +
        ...
        out.println("" +
                ...
                "<table>" +
                "<tr><td>Kundenname:</td></tr><tr><td><div id=\"cnameE\"><select id=\"cnameEselect\" onchange=\"GetSingleCustomer(\\\'cnameEselect\\\');\"><option selected value=\"0000\">Kunde w&auml;hlen</option></select></div></td></tr>" +
                "</table>" +
                "</div></div>');\n" +
                "" +
                "    \n" +
        ...
        if(Functions.UserIsPermitted(Uid,"managed_services_vae")) {
            ...
            out.println("" +
                ...
                "<tr><td><input type=\"text\" value=\"IH\" id=\"cotrsn\" onclick=\"ClearValue(\\'cotrsn\\');\"/></td><td><input type=\"text\" value=\"Inhouse\" id=\"cotrln\" onclick=\"ClearValue(\\'cotrln\\');\"/></td></tr>" +
                "<tr><td colspan=2>Welche Pflegeaufgaben sind diesem Vertragstyp zugeordnet?</td></tr>" +
                "<tr><td><div id=\"mactions\"><div id=\"mactionsc\"></div></div></td></tr>" +
                "</table>" +
                "</div>" +
                "</div>');\n" +
                "" +
        ...
        out.println("" +
                ...
                "<table>" +
                "<tr><td>Name:</td><td>Beschreibung</td></tr>" +
                "<tr><td><div id=\"cotrsnE\"><select id=\"cotrsnEselect\" onchange=\"GetSingleContractType(\\\'cotrsnEselect\\\');\"><option selected value=\"0000\">Vertragstyp w&auml;hlen</option></select></div></td><td><div contenteditable=\"true\" id=\"cotrlnE\">&nbsp;</div></td></tr>" +
                "<tr><td colspan=2>Welche Pflegeaufgaben sind diesem Vertragstyp zugeordnet?</td></tr>" +
                "<tr><td><div id=\"mactionsE\"><div id=\"mactionsEc\"></div></div></td></tr>" +
                "</table>" +
                "</div>" +
                "</div>');\n" +
                "" +
        ...
        out.println("" +
                ...
                "<table>" +
                "<tr><td>Name:</td></tr>" +
                "<tr><td><div id=\"cotrsnD\"><select id=\"cotrsnEselect\"><option selected value=\"0000\">Vertragstyp w&auml;hlen</option></select></div></td></tr>" +
                "</table>" +
                "</div>" +
                "</div>');\n" +
                "" +
        ...
        if(Functions.UserIsPermitted(Uid,"managed_services_csw")) {
            ...
            out.println("" +
                ...
                "        $('#CreateServiceEntryLeftMC div.jqte').css('height','405px');" +
                "        $('#CreateServiceEntryLeftMC .jqte_editor').css('height','356px');" +
                "        $('#CreateServiceEntryLeftMC .jqte_source').css('height','356px');" +
                ...
                "        $('#CreateServiceEntryLeftMC div.jqte').css('height','675px');" +
                "        $('#CreateServiceEntryLeftMC .jqte_editor').css('height','626px');" +
                "        $('#CreateServiceEntryLeftMC .jqte_source').css('height','626px');" +
                "        $('#CSEDsc2').css('color','#fff');\n" +
                "    }" +
                "}\n" +
            "");
            ...
            out.println("" +
                ...
                "<div id=\"CreateServiceEntryU\"><div id=\"CSEDsc\">Arbeiten wurden ausgef&uuml;hrt durch: </div><input type=text value=\"' + FullName + '\" disabled/><input id=\"InFrom\" type=hidden value=\"' + UserMail + '\" /></div>" +
                "<div id=\"CreateServiceEntryC\"><div id=\"CSEDsc\">Arbeiten wurden ausgef&uuml;hrt f&uuml;r: </div><div id=\"CreateServiceEntryCs\"><select id=\"CreateServiceEntryCselect\" onchange=\"GetSingleCustomerInfo(\\\'CreateServiceEntryCselect\\\');\"><option selected value=\"0000\">Kunde w&auml;hlen</option></select></div></div>" +
                "<div id=\"CreateServiceEntryA\"><div id=\"CSEDsc\">Auftragsnummer: </div><div id=\"CreateServiceEntryAs\"></div></div>" +
                "<div id=\"CreateServiceEntryT\"><div id=\"CSEDsc\">Typ des Eintrags: </div><div id=\"CreateServiceEntryTs\"><select id=\"CreateServiceEntryTselect\"><option selected value=\"0000\">Bitte w&auml;hlen</option></select></div></div>" +
                "<div id=\"CreateServiceEntryS\"><div id=\"CSEDsc\">Zeitstempel: </div><input id=\"CreateServiceEntryTime\" type=text value=\"' + now.format(\"yyyy-mm-dd HH:MM:ss\") + '\" /></div>" +
                "<div id=\"CreateServiceEntryD\"><div id=\"CSEDsc\">Dauer: (min)</div><input id=\"CreateServiceEntryDelay\" type=text value=\"15\" /></div>" +
                ...
                "<div id=\"InANt\">An:</div><input id=\"InAN\" type=\"text\" />" +
                "<div id=\"InCCt\">Cc:</div><input id=\"InCC\" type=\"text\" />" +
                "<div id=\"InSubt\">Btr.</div><input id=\"InSub\" type=\"text\" value=\"\" />" +
                ...
                "<input id=\"InEsk1\" type=\"text\" value=\"\" />" +
                ...
                "<input id=\"InEsk2\" type=\"text\" value=\"\" />" +
                ...
                "<input id=\"InEsk3\" type=\"text\" value=\"\" />" +
                "</div></div>" +
                "<div id=\"CreateServiceEntryLeft\">" +
                "<div id=\"CreateServiceEntryLeftMH\"><div id=\"CreateServiceEntryLeftMHc\"></div></div>" +
                "<div id=\"CreateServiceEntryLeftMC\"><div id=\"CreateServiceEntryLeftMCc\"></div></div>" +
                "<div id=\"CreateServiceEntryLeftMF\"><div id=\"CreateServiceEntryLeftMFc\"></div></div>" +
                "</div>" +
                "</div>');\n" +
                "" +
        ...
        if(Functions.UserIsPermitted(Uid,"managed_services_ki")) {
            ...
            out.println("" +
                    ...
                    "<div id=\"CreateCustomerLeft\">" +
                    "<table>" +
                    "<tr><td>Kundenname:</td></tr><tr><td><input type=\"text\" id=\"cnameE\" disabled/></td></tr><tr><td>Kundennummer:</td></tr><tr><td><input type=\"text\" id=\"cnumberE\" disabled/></td></tr>" +
                    "<tr><td>Kontakt E-Mail Adressen: (mail1,mai2,mailn)</td></tr><tr><td><input type=\"text\" id=\"cmailE\" disabled/></td></tr><tr><td>Eskalationsmailadressen: (mail1,mail2,mailn)</td></tr><tr><td><input type=\"text\" id=\"cesmailE\" disabled/></td></tr>" +
                    "<tr><td>Kontakt Adresse:</td></tr><tr><td><div id=\"caddressE\"></div></td></tr>" +
                    "</table>" +
                    "</div>" +
                    "<div id=\"CreateCustomerMiddle\">" +
                    "<table>" +
                    "<tr><td>Weitere Informationen zu diesem Kunden:</td></tr><tr><td><div id=\"ccommE\"></div></td></tr>" +
                    "</table>" +
                    "</div>" +
                    "<div id=\"CreateCustomerRight\">" +
                    "<table>" +
                    ...
                    "                    $('#ContractsDivInner').html('');\n" +
                    "                    $.each(json.CONTRACTS, function() {\n" +
                    "                        $('#ContractsDivInner').append('<div id=\"CT_Outer\"><div id=\"CT_Head\"><span>Vertrag: </span><span>' + $.base64.decode( this.COTRLN ) + '</span></div><div id=\"CT_AN\"><span>Auftragsnummer: </span><span>' + $.base64.decode( this.CCNR ) + '</span></div><div id=\"CT_PR\"><span>Umgebung: </span><span>' + $.base64.decode( this.CCPRDC ) + ' (' + $.base64.decode( this.CCPRVE ) + ')</span></div></div>');\n" +
                    "                    });\n" +
                    "                },\n" +
                    "                dataType: 'json',\n" +
                    "                cache: false\n" +
            ...
            out.println("" +
                    ...
                    "        success: function(json) {\n" +
                    "            $.each(json.CUSTOMER, function() {\n" +
                    "                $('#MSI_Cont').append('<div id=\"CustomerInfoEntry\" onclick=\"ShowCustomer(\\\'' + $.base64.decode( this.CUID ) + '\\\');\"><span id=\"CustomerInfoEntryHeader\">' + $.base64.decode( this.CUNM ) + '</span><br><span id=\"CustomerInfoEntryContent\">Kundennummer: ' + $.base64.decode( this.CUNR ) + '</span></div>');\n" +
                    "            });\n" +
                    "        },\n" +
                    "        dataType: 'json',\n" +
                    "        cache: false\n" +
